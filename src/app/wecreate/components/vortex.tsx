...
export function VortexDemo() {
  return (
    <div className="w-screen h-screen  m-0 p-0 overflow-hidden ">
      ...
      >
        <h2 className="text-textcolor-yellow text-6xl md:text-8xl font-thicccboi text-center">
          We Create
        </h2>
        <p className="text-white text-sm md:text-2xl max-w-6xl font-bold font-thicccboi mt-6 text-center">
