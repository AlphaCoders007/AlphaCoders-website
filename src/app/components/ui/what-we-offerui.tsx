      ...
      >
        ...
        <div className="relative z-40 p-8  ">
          ...
          <motion.p
            ...
            className=" dark:text-textcolor-yellow text-textcolor-lightcolor    text-lg md:text-2xl  font-thicccboi text-left drop-shadow-[0_2px_4px_rgba(0,0,0,0.7)] tracking-wide  mb-2"
          >
            {card.category}
          </motion.p>
          {/* Title Text */}
