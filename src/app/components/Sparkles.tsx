...
export function Sparkles() {
  return (
    <div className="h-[45rem] w-full bg-black flex flex-col items-center justify-center overflow-hidden relative">
      {/* Title Section */}
      <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-center text-white relative z-20 max-w-4xl px-6">
        We Design
      </h1>
