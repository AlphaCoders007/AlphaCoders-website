    ...
    >
      ...
      <div className="relative z-40 p-8">
        ...
        <motion.p
          ...
          className="text-white text-sm md:text-xl font-medium font-sans text-left drop-shadow-lg"
        >
          {card.category}
        </motion.p>
        {/* Title Text */}
        <motion.p
          ...
          className="text-white text-xl md:text-3xl font-semibold max-w-xs text-left [text-wrap:balance] font-sans mt-2 drop-shadow-lg"
        >
          {card.title}
        </motion.p>
      </div>
