      ...
      <BentoGridUI className="z-10 grid grid-cols-2 bg-background-light transition-colors ">
        {technologies.map((item, i) => (
          <BentoGridItem
            ...
            header={item.imgSrc ? <Image src={item.imgSrc} width={600} height={600} alt={item.title} className="w-full h-40 object-cover rounded-xl" /> : <div className="w-full h-40 bg-neutral-200 rounded-xl"></div>}
